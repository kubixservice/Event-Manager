...
OnStart:
	...
	monster return_Event_Map( $Event ), return_Event_X( $Event ), return_Event_Y( $Event ), "Run for your Life!", $@RFYL_MOBID, 1, strnpcinfo(0) + "::OnMobDie";
